...
## Project Structure
    ...
    ├── testapiautodatamod_127599  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_127599`
...
2. Clone this repo and `cd testapiautodatamod_127599`
